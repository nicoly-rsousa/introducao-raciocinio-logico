...
//R: sexta
console.log('Se ontem foi quarta amanhã será')
console.log('HOJE : QUINTA')
console.log('AMANHÃ : SEXTA')
console.log("------------------------------------------------------------------------------")
console.log('2. Complete a sequência: 1, 4, 9, 16, 25, ...')
//R: 36
console.log('1, 4, 9, 16, 25')
console.log('1+3, 4+5, 9+7, 16+9, 25+11')
console.log('=36')
console.log("------------------------------------------------------------------------------")
...
console.log('R: 50 KM == 50000 metros')
console.log('Total distancia 100+50 =150 m')
console.log('(150 * 60)/50000=0,18m ')
console.log('0,18*60= 10,8 segundos')
console.log("------------------------------------------------------------------------------")
...
console.log("R:3 (pai, avô e filho")
